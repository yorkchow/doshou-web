package me.doshou.common.web.bind.method.annotation;

import me.doshou.common.web.utils.URLDecodeUtils;
        ...
        while (parameterNames.hasNext()) {
            ...
            if (name.startsWith(namePrefix)) {
                ...
                if (subPrefix) {
                    ...
                    // decoding
                    String[] params = URLDecodeUtils.decode(request.getParameterValues(name));
                    result.put(name.substring(namePrefixLength + 1), params);
                } else {
