 ...
 */
@Controller
@RequestMapping("/admin/maintain/website/product")
@RequiresPermissions("maintain:website:product:*")
public class WebsiteProductController extends BaseMultipartFileController<Product, Long> {
    ...
    public WebsiteProductController() {
        setResourceIdentity("maintain:website:product");
    }
    ...
    public String create(
            ...
            Model model,
            @Valid @ModelAttribute("m") Product m, BindingResult result,
    ...
    public String update(
            HttpServletRequest request,
            Model model, @Valid @ModelAttribute("m") Product m, BindingResult result,
            @RequestParam(value = "file", required = false) MultipartFile file,
