...
<form id="searchForm" class="form-inline search-form" data-change-search="true">
    ...
    <dsform:label path="search.lastStopTimestamp_gte">最后退出时间从</dsform:label>
    <div class="input-append date" style="display: inline-block;">
        <dsform:input path="search.lastStopTimestamp_gte" cssClass="input-medium"
                      data-format="yyyy-MM-dd hh:mm:ss"
                      placeholder="大于等于"/>
        <span class="add-on"><i data-time-icon="fa fa-clock-o" data-date-icon="fa fa-calendar"></i></span>
    </div>
    <dsform:label path="search.lastStopTimestamp_lte">到</dsform:label>
    <div class="input-append date" style="display: inline-block;">
        <dsform:input path="search.lastStopTimestamp_lte" cssClass="input-medium"
                      data-format="yyyy-MM-dd hh:mm:ss"
