...
<div class="panel">
    <ul class="nav nav-tabs">
        <shiro:hasPermission name="maintain:website:store:create">
            <c:if test="${op eq '新增'}">
                <li ${op eq '新增' ? 'class="active"' : ''}>
                    <a href="${ctx}/admin/maintain/website/store/create?BackURL=<doshou:backURL/>">
        ...
        <c:if test="${not empty m.id}">
            <li ${op eq '查看' ? 'class="active"' : ''}>
                <a href="${ctx}/admin/maintain/website/store/${m.id}?BackURL=<doshou:backURL/>">
                    <i class="fa fa-eye fa-fw"></i> 查看
                </a>
            </li>
            <shiro:hasPermission name="maintain:website:store:update">
                <li ${op eq '修改' ? 'class="active"' : ''}>
                    <a href="${ctx}/admin/maintain/website/store/${m.id}/update?BackURL=<doshou:backURL/>">
    ...
    <form:form id="editForm" method="post" commandName="m" cssClass="form-inline form-horizontal form-small form-wrapper"
        ...
        <div id="baseinfo" class="baseinfo container">
            <div class="row">
                <h4 class="hr">商铺基本信息</h4>

                <div class="control-group col-sm-12 col-md-12 col-lg-12">
                    <form:label path="category.id" cssClass="control-label">商铺类别</form:label>
                    <div class="controls">
                ...
                <div class="control-group col-sm-6 col-md-6 col-lg-6">
                    <form:label path="name" cssClass="control-label">商铺名称</form:label>
                    <div class="controls">
                ...
                <div class="control-group col-sm-6 col-md-6 col-lg-6">
                    <form:label path="url" cssClass="control-label">商铺URL</form:label>
                    <div class="controls">
