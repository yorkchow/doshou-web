                                    ...
                                    <div class="colored nopbump rel">
                                        ...
                                        <div class="singlecp bumpsm dark">
                                            <a href="${store.url}" target="_blank">
                                                <img src="${ctx}/static/front/images/pixel.jpg" data-url="${store.imgUrl}" class="loadingImg img-responsive opac"/>
                                            </a>
                                        </div>

                                        <div class="post-text-grip topbtmbumpmin">
                                            <p>
                                                <a class="read-more" href="${store.url}" target="_blank">${store.name}</a>
                                                <a href="${store.url}" class="btn btn-danger" role="button" target="_blank" style="float: right;">去看看</a>
                                            </p>
                                        </div>

                                        <div class="post-text-grip linetop-pads">
                                            <div class="infodiv accent pull-left bumpright">${store.addDate}</div>
                                        </div>
