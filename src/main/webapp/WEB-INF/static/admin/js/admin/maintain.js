$.maintain = {
    ...
    website : {
        initValidator : function(form) {
            var ajaxCall = {
                "url": ctx + "/admin/maintain/website/product/validate",
                //动态提取的数据。验证时一起发送
                extraDataDynamic: ['#id'],
                //验证失败时的消息
            ...
            $.validationEngineLanguage.allRules.brief = {
                "regex": /^[\u4E00-\u9FA5\uf900-\ufa2d_a-zA-Z][\u4E00-\u9FA5\uf900-\ufa2d\w]{1,200}$/,
                "alertText": "* 2到200个汉字、字母、数字或下划线组成，且必须以非数字开头"
            };
            $.validationEngineLanguage.allRules.number = {
                "regex": /^[1-9]\d*$/,
                "alertText": "* 数字开头非0"
            };
