    ...
    organization : {
        initSelectForm : function(organizationFormName, jobFormName, isAuthSelect) {
            ...
            $(".btn-add-organization").click(function() {
                ...
                var template =
                    ...
                    "</td>" +
                    "<td>" +
                    "<a class='btn btn-link btn-edit btn-delete-organization' href='javascript:;' onclick='$.sys.organization.removeOrganization(this);'><i class='fa fa-trash-o fa-fw'></i></a>" +
                    "</td>" +
                    "</tr>";
            ...
            $(".btn-delete-all-organization").click(function() {
                ...
                */
                ...
                $.messager.confirm("确认删除组织机构和工作职务", "确认删除选中的组织机构和工作职务吗？", function() {
                    checkbox.each(function() {
                        $(this).closest("tr").remove();
                    });
                });
        ...
        removeOrganization : function(a) {
            ...
            */
            ...
            $.messager.confirm("确认执行操作", "确认删除吗？", function() {
                $(a).closest('tr').remove();
            });
        }
    },
    user : {
        initValidator : function(form) {
            ...
            $.validationEngineLanguage.allRules.mobilePhoneNumber = {
                "regex": /^0{0,1}(13[0-9]|15[0-9]|14[0-9]|18[0-9])[0-9]{8}$/,
                "alertText": "* 手机号错误"
            };
        ...
        initUserListButton : function() {
            $(".change-password").click(function() {
                ...
                */
                ...
                $.messager.confirm("修改密码", "请输入新密码：<br/><input type='password' id='password' class='input-medium'/>", function() {
                    var password = $("#password").val();
                    if(password) {
                        window.location.href = url + "&newPassword=" + password;
                    }
            ...
            $(".block-user,.unblocked-user").click(function() {
                ...
                $.messager.confirm(title, tip + "<br/><textarea id='reason' style='width: 300px;height: 50px;'></textarea>", function() {
                    var reason = $("#reason").val();
                    if(reason) {
                        window.location.href = url + "&reason=" + reason;
                    }
            ...
            $(".recycle").click(function() {
                ...
                */
                ...
                $.messager.confirm("还原删除的用户", "确认还原吗？", function() {
                    window.location.href = url;
                });
            });
        ...
        initOnlineListButton : function() {
            $(".btn-force-logout").click(function() {
                ...
                */
                ...
                $.messager.confirm("强制退出用户", "确认强制退出吗？", function() {
                    var url = ctx + "/admin/sys/user/online/forceLogout?" + checkbox.serialize();
                    window.location.href = url;
                });
            });
